...
#ifndef AUDIO_HELPERS_HPP
#define AUDIO_HELPERS_HPP
...
inline f32 CalculateVoiceVolume( voice* pVoice, xbool AudioDuckingEnabled )
{
...
inline f32 CalculateElementVolume( element* pElement, xbool AudioDuckingEnabled )
{
