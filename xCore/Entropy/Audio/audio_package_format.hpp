//==============================================================================
//
//  audio_package_format.hpp
//
//==============================================================================

#ifndef AUDIO_PACKAGE_FORMAT_HPP
#define AUDIO_PACKAGE_FORMAT_HPP
...
//==============================================================================
// INDEX (ELEMENT) ENCODING/DECODING MACROSES
//==============================================================================
...
//==============================================================================
// DESCRIPTOR ENCODING/DECODING MACROSES
//==============================================================================
...
//==============================================================================
// PARAMETER COMPRESSION MACROSES
//==============================================================================
...
//==============================================================================
// PARAMETER DE-COMPRESSION MACROSES
//==============================================================================
...
{
    HOT_SAMPLE = 0,
    WARM_SAMPLE,        // Reserved legacy slot; not supported.
    COLD_SAMPLE,
    NUM_TEMPERATURES,
};
...
{
    HOT=0,
    WARM,               // Reserved legacy slot; not supported.
    COLD,
};
...
enum index_type
{
    ...
    WARM_INDEX,         // Reserved legacy slot; not supported.
...
{
    uaddr           AudioRam;         // Runtime address in audio ram.
...
//==============================================================================
#endif // AUDIO_PACKAGE_FORMAT_HPP
//==============================================================================
