...
#ifdef DXC_USE_DIRECTX_HEADERS
// DirectX-Headers supplies the Linux ABI definitions used by d3d12shader.h.
// Include it before the adapter so only the DXC compatibility helpers and COM
// wrappers below are added by this file.
#include <basetsd.h>
#undef interface
#undef IN
#undef OUT
...
#ifndef DXC_USE_DIRECTX_HEADERS
#ifdef __EMULATE_UUID
struct GUID
#else  // __EMULATE_UUID
