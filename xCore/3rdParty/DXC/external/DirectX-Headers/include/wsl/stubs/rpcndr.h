...
/* DXC's WinAdapter provides the emulated __uuidof implementation.  Do not
 * replace it with the WSL stub: the latter leaves unresolved
 * __wsl_stub_uuidof symbols when dxcompiler is linked. */
