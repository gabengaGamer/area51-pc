...
void player::UpdateDeath( const f32& DeltaTime )
{
    ...
    xbool PrimaryPressed = g_IngamePad[m_ActivePlayerPad].GetLogical( ingame_pad::ACTION_PRIMARY ).GetWasValue() > 0.25f;
...
void player::UpdateIdle( const f32& DeltaTime )
{
    ...
    if( !m_bHidePlayerArms )
    {
        ...
        xbool bPressedReload   = !bUsedFocusObject && (g_IngamePad[m_ActivePlayerPad].GetLogical( ingame_pad::ACTION_RELOAD ).GetWasValue() > 0.25f);
