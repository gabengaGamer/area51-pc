...
{
    X_PROFILE_SCOPE_CATEGORY( "Context", "skin_prop_surface::OnRender" );
...
void skin_prop_surface::OnAdvanceSimulation( f32 DeltaTime )
{
    X_PROFILE_SCOPE_CATEGORY( "Context", "skin_prop_surface::OnAdvanceSimulation" );
