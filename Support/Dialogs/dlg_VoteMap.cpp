...
{
    // Frames.
    { IDC_VOTE_MAP_LISTBOX,   "IDS_VOTE_MAP",     "maplist",  45,  60, 260, 238, 0, 0, 1, 1, ui_win::WF_VISIBLE },
};
...
void dlg_vote_map::OnAccept( ui_win* pWin )
{
    (void)pWin;
...
void dlg_vote_map::OnCancel( ui_win* pWin )
{
    (void)pWin;
