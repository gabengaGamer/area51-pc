...
{
    // Frames.
    { IDC_KICK_PLAYER_LISTBOX,   "IDS_KICK_PLAYER",  "playerlist",  45,  60, 320, 238, 0, 0, 1, 1, ui_win::WF_VISIBLE },
};
...
void dlg_kick_player::OnAccept( ui_win* pWin )
{
    (void)pWin;
...
void dlg_kick_player::OnCancel( ui_win* pWin )
{
    (void)pWin;
