...
struct fx_element_def
{
    ...
    s32         TypeIndex;          //
    xbool       ReadZ;              //
    s32         CombineMode;        // Serialized FX material mode; decoded by fx_Render.
...
const   vector3&    GetTranslation  ( void ) const;
        ...
        void        SubmitRender    ( void );

const   texture*    GetDiffuseTexture( s32 Index ) const;
