...
#ifndef POINT_SHADOW_BUCKET_COUNT
...
TextureCubeArray<float> txPointShadowCube[POINT_SHADOW_BUCKET_COUNT] : register(t16);
Texture2D<float4> txFaceShadowAtlas                                   : register(t20);
