...
public:
    ...
    const   char*       GetSourceFileName           ( void ) const;
...
protected:
    ...
    struct source_mesh_info
    {
        char    Name[MAX_NAME_LENGTH];
    };

    struct source_tex_info
    {
        char    Name[MAX_NAME_LENGTH];
    };
    ...
    char                    m_FileName[MAX_NAME_LENGTH];            // Geometry source file
    char                    m_PhysicsSource[MAX_NAME_LENGTH];       // Physics source file
    char                    m_SettingsFile[MAX_NAME_LENGTH];        // Settings file name
    xarray<uv_animation>    m_UVAnimList;                           // UV animations from the source
    ...
    xarray<source_mesh_info> m_SourceMeshList;                      // Imported mesh names
    xarray<source_tex_info>  m_SourceDiffuseList;                   // Imported diffuse textures
...
inline
void geom_rsc_desc::SetSourceFileName( const char* pFileName )
{
...
inline
const char* geom_rsc_desc::GetSourceFileName( void ) const
{
    return m_FileName;
}
